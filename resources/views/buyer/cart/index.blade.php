            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    ...
                    <div class="row mb-4 align-items-center">
                        <div class="col-md-2">
                             <img src="{{ $item->product->primaryImage ? $item->product->primaryImage->url : 'https://placehold.co/150x150?text=No+Image' }}" class="img-fluid rounded" alt="{{ $item->product->name }}">
                        </div>
                        <div class="col-md-4">
