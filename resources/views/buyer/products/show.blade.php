    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            @if($product->primaryImage)
                <img src="{{ $product->primaryImage->url }}" class="img-fluid rounded shadow-sm mb-3 w-100" style="max-height: 500px; object-fit: cover;" alt="{{ $product->name }}">
            @else
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm border-0">
                    <img src="{{ $related->primaryImage ? $related->primaryImage->url : 'https://placehold.co/300x300?text=No+Image' }}" class="card-img-top" alt="{{ $related->name }}" style="height: 200px; object-fit: cover;">
                    <div class="card-body">
